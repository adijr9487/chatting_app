export default function Mute(height, color) {
  return (
    <svg
      version="1.1"
      id="Capa_1"
    ...
    >
      <path fill={color} d="M352.021,16.075c0-6.08-3.52-11.84-8.96-14.4c-5.76-2.88-12.16-1.92-16.96,1.92l-141.76,112.96l167.68,167.68V16.075z" />
      <path fill={color}
